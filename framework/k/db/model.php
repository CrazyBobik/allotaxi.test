...
class K_Db_Model extends K_Validator {
    ...
    */
    ...
    /**
     * @function removeID - óäàëåíèå çàïèñè ïî id
     ...
     *  
     * model->mfo(select()->where()) 
     *  
     */
    
    /** @function mfa - àëèàñ ê fethAll âûáîð ñïèñêà çàïèñåé
     * 
     */
    ...
    /** @function mfr - àëèàñ ê fetchArray âûáîð ìàññèâà
     * 
     */
       
    public function mfy($sql = null, $count = 0) {
        
       return  $this->fetchArray($sql, $count);
            
    }
    
    /** @function mfr - Возвращяет одну строку и базы, короткий алиас к fetchRow
     * 
     */
       
    
    public function mfr($sql = null) {
    ...
    /** @function select - ñîðêàù¸ííûé âàðèàíò âûçîâà êîíñòðóêòîðà K_Db_Select
     * 
     */
